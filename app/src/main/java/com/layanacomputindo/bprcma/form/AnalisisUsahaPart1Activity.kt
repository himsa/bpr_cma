...
import kotlinx.android.synthetic.main.activity_analisis_usaha_part1.*
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response
import java.util.*

class AnalisisUsahaPart1Activity : AppCompatActivity(), RadioGroup.OnCheckedChangeListener, View.OnClickListener, DatePickerDialog.OnDateSetListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_analisis_usaha_part1)
        ...
        btn_next_an_usaha1.setOnClickListener(this)
        tv_spesifikasi_usaha.setOnClickListener(this)
    }

    private fun setDummy() {
        et_deskripsi_usaha.setText("Jual Mac Book Baru dan Bekas")
        tv_spesifikasi_usaha.setText("20/3/2016")
        et_des_pnghsln_smpngn.setText("Importir Beras")
    }
    ...
    private fun submitData() {
        ...
        val call = service.sendUsahaDebitur(idKredit, et_detail_keterangan.text.toString(), et_detail_keterangan.text.toString(),
        ...
        call.enqueue(object: Callback<Result<UserId>>{
            ...
            override fun onResponse(call: Call<Result<UserId>>, response: Response<Result<UserId>>) {
                ...
                if(response.isSuccessful){
                    ...
                    if (result != null) {
                        if (result.getStatus()!!) {
                            startActivity(Intent(this@AnalisisUsahaPart1Activity, AnalisisUsahaPart2Activity::class.java))
                        } else {
    ...
    override fun onCheckedChanged(p0: RadioGroup?, p1: Int) {
        when(p1){
            R.id.rb_milik_sendiri -> {
                ...
                uploadStatus = radioButton.text.toString()
            }
            R.id.rb_keluarga -> {
